...
void Application::Display(void)
{
	...
	//m_pMesh->Render(m4Projection, m4View, ToMatrix4(m_m4Model));   //render based on vectors

	//m_qOrientation = m_qOrientation * glm::angleAxis(glm::radians(1.0f), vector3(1.0f));  
	m_pMesh->Render(m4Projection, m4View, ToMatrix4(m_qOrientation));      //render based on quaternion so as to prevent gimble lock
