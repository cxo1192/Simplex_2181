...
class Application
{
	...
	std::vector<std::vector<vector3>> allStops; //list of list of vertexs to stop at
	std::vector<uint> startIndexs; //list of indexs of start points for each sphere
	std::vector<uint> endIndexs; //list of indexes of end points for each sphere
	String m_sProgrammer = "Cameron Ostrom - cxo1192@rit.edu";
